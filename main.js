...
client.on("messageCreate", (message) => {
    ...
    switch (args[0]) {
        ...
        case "help":
            ...
            .setColor("RANDOM")
            .setTitle(`指令清單`)
            .setThumbnail('https://yt3.googleusercontent.com/ytc/AMLnZu94-ySJed0xn3qFHvBOigTYtFitZBRvxxa31OPY=s176-c-k-c0x00ffffff-no-rj')
            .setDescription(`方糖機器人使用\`)\`作指令前綴:
...
// > \`you_are_dl\`  方糖會否認
        ...
        case "link":
            const LinkEmbed = new MessageEmbed()
                ...
                .setThumbnail('https://yt3.googleusercontent.com/ytc/AMLnZu94-ySJed0xn3qFHvBOigTYtFitZBRvxxa31OPY=s176-c-k-c0x00ffffff-no-rj')
                .addFields(
                    { name: '主頻道', value: 'https://tinyurl.com/46au4puc', inline: true },
                    { name: '副頻道', value: 'https://tinyurl.com/2uzy9bpe', inline: true },
                    { name: '?', value: 'https://tinyurl.com/2cynyt6e', inline: true },
                    { name: 'AI證明', value: 'https://tinyurl.com/yc65zaf8', inline: true },
                    { name: 'krac bac reup', value: 'https://tinyurl.com/4d2en243', inline: true },
                    { name: "原批跳舞", value: "https://tinyurl.com/2bhcyt6f", inline: true },
                    { name: 'yes23', value: 'https://tinyurl.com/4yyt7s9z', inline: true },
                    { name: '推特', value: 'https://tinyurl.com/y9fhnucf', inline: true },
                    { name: 'B站', value: 'https://tinyurl.com/ysk6mnyp', inline: true },
                    { name: 'DC', value: '\`yee0931\`', inline: true },
                )
                .setFooter({ text: '方糖機器人' });
            return message.reply({
                embeds: [LinkEmbed]
        ...
        case "dl":
            if (message.author.id == "972686722729123880" || message.author.id == "910859579548635146") {
                message.reply("天啊是雨日啊我好感動啊啊啊啊啊啊啊啊雨日是大佬!!!!🛐🛐🛐🛐")
            } else {
                message.reply("雨日是大佬!🛐")
            }
        ...
        case "sorry":
            message.channel.send("對不起!! <:setfire_crying:1005497109434347611> <:setfire_crying:1005497109434347611>");
